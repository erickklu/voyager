...
class PublicacioneController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function show(Request $request, $id)
    {
        ...
        /* Asignación de route del controlador VoyagerUserController para la vista READ de usuarios */
        /* Ya que no pude asignar la vista read en el controllador VoyagerUserController */
        /* $route = '';
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted', 'publicaciones'));
    }
